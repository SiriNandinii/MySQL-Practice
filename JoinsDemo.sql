...
SELECT employeeNumber, CONCAT(lastName, ' ', firstName) AS 'Name', city 
...
SELECT productCode, textDescription, quantityInStock
...
SELECT STATUS,SUM(quantityOrdered*priceEach) 'Total'
